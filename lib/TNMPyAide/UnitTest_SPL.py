...
print('       Log Avg should be 67.4036')
print('       Log Avg = ' + str(round(spl.Compute_LOG_AVG(nparray), 4)))
if round(spl.Compute_LOG_AVG(nparray), 4) == round(67.40362689, 4):
    print('LOG_AVG = PASS')
else:
    print('LOG_AVG = FAIL')

# UT 02: Compute Leq_24_Hour, Ldn, Lden for clean FLOAT ARRAY data
...
# UT 03: Compute Leq_24_Hour, Ldn, Lden for clean INTEGER DATAFRAME data
# Pass a df with 24 rows and one column that has int data, all at 60
# Result Leq_24_hour = 60, Ldn = 66.40978057, Lden = 66.67012337           
...
# UT 04: Compute Leq_24_Hour, Ldn, Lden for clean dataCompute Leq_24_Hour, Ldn, Lden for clean STRING LIST data
...
# UT 05: Compute Leq_24_Hour, Ldn, Lden for clean dataCompute Leq_24_Hour, Ldn, Lden for clean STRING TUPLE data
...
# This is also the farthest removed object from the intended numpy array that should work
# Result Leq_24_hour = 60, Ldn = 66.40978057, Lden = 66.67012337 
tuple_obj = ('apple','fred','60','60',60,'60','60',60.0,'60',60,'60','60','60','60',
