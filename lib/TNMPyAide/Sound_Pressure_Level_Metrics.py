...
class Sound_Pressure_Level_Metrics:
    ...
    def Compute_LOG_AVG(float_array):
        SUM = Sound_Pressure_Level_Metrics.Compute_LOG_SUM(float_array)
        AVG = SUM - 10*np.log10(len(float_array))
        return AVG
    
    @staticmethod
    def Compute_LOG_SUM(float_array):
        SUM = 10*np.log10(sum(10**(float_array/10)))
        return SUM
    ...
    def Validate_24_Hour_Data(data_24_hrs, spl_col_name = None):
        ...
        # if we get here, data_24_hrs is now an np array of floats
    ...
    def LEQ_24_HR(data_24_hrs, spl_col_name = None):
        ...
        data_24_hrs = Sound_Pressure_Level_Metrics.Validate_24_Hour_Data(data_24_hrs, spl_col_name)
        ...
        LAeq_24hrs = Sound_Pressure_Level_Metrics.Compute_LOG_AVG(data_24_hrs)
        return LAeq_24hrs
    ...
    def LDN(data_24_hrs, spl_col_name = None):
        ...
        # Compute Average
        Ldn = Sound_Pressure_Level_Metrics.Compute_LOG_AVG(data_24_hrs)
        return Ldn
    ...
    def LDEN(data_24_hrs, spl_col_name = None):
        ...
        # Compute Average
        Lden = Sound_Pressure_Level_Metrics.Compute_LOG_AVG(data_24_hrs)
        return Lden