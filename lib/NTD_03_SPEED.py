...
def SPEED(SELECT_STATE, PATH_NPMRDS, /, PATH_OUTPUT='Final Output'):
    ...
    df['VEH_HR10'] = df['PCT_TYPE10']*df['MAADT']*df['TT_PASS']/3600
    df['VEH_HR25'] = df['PCT_TYPE25']*df['MAADT']*df['TT_PASS']/3600
    df['VEH_HR40'] = df['PCT_TYPE40']*df['MAADT']*df['TT_TRUCK']/3600
    df['VEH_HR50'] = df['PCT_TYPE50']*df['MAADT']*df['TT_TRUCK']/3600
    df['VEH_HR60'] = df['PCT_TYPE60']*df['MAADT']*df['TT_TRUCK']/3600
    df['VMT10'] = df['PCT_TYPE10']*df['MAADT']*df['tmc_length']
    df['VMT25'] = df['PCT_TYPE25']*df['MAADT']*df['tmc_length']
    df['VMT40'] = df['PCT_TYPE40']*df['MAADT']*df['tmc_length']
    df['VMT50'] = df['PCT_TYPE50']*df['MAADT']*df['tmc_length']
    df['VMT60'] = df['PCT_TYPE60']*df['MAADT']*df['tmc_length']
